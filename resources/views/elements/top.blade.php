                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="mainmenu pull-left">
                            <ul class="nav navbar-nav collapse navbar-collapse">
                                ...
                                <li class="dropdown"><a href="{{URL::to('/product')}}">Cửa hàng<i class="fa fa-angle-down"></i></a>
                                ...
                                <li class="dropdown"><a href="{{URL::to('/news')}}">Tin tức<i class="fa fa-angle-down"></i></a>
                                    <ul role="menu" class="sub-menu">
